...
const ContactUs = () => {
  ...
  const { name, message, email, phoneNumber, address } = formValue;
        ...
        w-10/12 lg:w-8/12  bg-white rounded-xl mx-auto shadow-lg overflow-hidden"
          ...
          "
              ...
              <div className="w-full lg:w-1/2 py-16 px-12">
                ...
                <h2 className="text-3xl mb-4 text-neutral">Contact Us</h2>
                <p className="mb-4 text-gray-500">Make an order</p>
                ...
                <div className="flex justify-between gap-5">
                  ...
                  <div className="w-[50%]">
                    <input
                      type="text"
                      placeholder="Anything you want to know about kyro"
                      name="message"
                      className={`${inputStyle} capitalize`}
                      onChange={handleFormChange}
                    />
